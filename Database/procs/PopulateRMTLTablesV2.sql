...
/****** Object:  StoredProcedure [dbo].[PopulateRMTLTablesV2]    Script Date: 12/13/2021 9:09:36 PM ******/
SET ANSI_NULLS ON
GO
...
set @Rating='ABF'
EXECUTE @RC = [PopulateRMTLTablesV2] @Rating
...
Options:
  ...
  ------------------------------------------------------
Modifications
22-01-12 mparsons - new version for updated tables
		- ResourceReference replaces Source
		- Remove Assessment
		- Work Element Type becomes a ReferenceType concept
		- Concept.Label to Concept.Name

*/

Create PROCEDURE [dbo].[PopulateRMTLTablesV2]
		@Rating           varchar(50) = ''
As
SET NOCOUNT ON;
...
grant execute on [PopulateRMTLTablesV2] to public
go