...
/*
	...
	Modifications
	22-02-07 mp - Seemed to have lost the updates to make the WorkElementType the primary focus, in order to show where there were zero tasks. 
*/
Create  VIEW [dbo].[RatingTaskSourceSummaryOLD]
AS
