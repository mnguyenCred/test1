...
namespace Factories
{
    public class AssessmentManager : BaseFactory
    {
                        ...
                        if ( efEntity != null && efEntity.Id > 0 )
                        {
                            ...
                            if ( isValid )
                            {
                                SiteActivity sa = new SiteActivity()
                                {
                                    ...
                                    Activity = "Import",
                                    Event = "Update",
                                    Comment = string.Format( "Assessment was updated by the import. Name: {0}", entity.Name ),
                ...
                try
                {
                    ...
                    if ( count > 0 )
                    {
                        ...
                        SiteActivity sa = new SiteActivity()
                        {
                            ...
                            Activity = "Import",
                            Event = "Add",
                            Comment = string.Format( "Full Assessment was added by the import. Name: {0}", entity.Name ),
                            ActivityObjectId = entity.Id
                        };
                        new ActivityManager().SiteActivityAdd( sa );
        ...
        public static List<AppEntity> GetAll()
        {
            ...
            using ( var context = new DataEntities() )
            {
                var results = context.Assessment
                        .OrderBy( s => s.Name )
                        .ToList();
                if ( results?.Count > 0 )
                {
