...
namespace Utilities
{
    public class LoggingHelper
    {
		...
		private static string DefaultSubject = "Navy RRL Application Exception encountered";
        ...
        public static void LogError( Exception ex, string message, bool notifyAdmin, string subject = "Navy RRL Application Exception encountered" )
        {
